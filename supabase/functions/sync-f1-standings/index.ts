...
import syncStandings from "./_helpers/syncStandings.ts";
console.log("sync-f1-standings started");
...
/* To invoke locally:
  ...
  curl -i --location --request POST 'http://127.0.0.1:54321/functions/v1/sync-f1-standings' \
