...
async function HomeContent() {
  ...
  return (
    <main
      ...
      style={{ backgroundImage: "url('/image.png')", backgroundSize: "80%" }}
    >
      <div className="flex flex-col items-center gap-8">
        ...
        <form action={signInWithGoogle}>
          <button
            type="submit"
            className="flex items-center gap-3 bg-white hover:bg-zinc-100 active:bg-zinc-200 transition-colors duration-150 text-zinc-800 font-medium text-sm px-6 py-3 rounded-full shadow-md cursor-pointer"
          >
